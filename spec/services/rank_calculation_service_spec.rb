...
RSpec.describe RankCalculationService, type: :service do
  describe '#perform' do
    ...
    let!(:book_rank_a) {create(:book_rank, rank: rank, book: book_a, view: 50)}
    let!(:book_rank_b) {create(:book_rank, rank: rank, book: book_b, view: 30)}
    let!(:book_rank_c) {create(:book_rank, rank: rank, book: book_c, view: 80)}
    let!(:book_rank_d) {create(:book_rank, rank: rank, book: book_d, view: 10)}
    let!(:book_rank_e) {create(:book_rank, rank: rank, book: book_e, view: 70)}
